import {
  ...
  viewAllFavoritesUseCase,
} from "../../use-cases/favorite";
...
export const getFavoriteForProfileController =
  fetchFavoriteForProfileController({ viewAllFavoriteForProfilesUseCase });
