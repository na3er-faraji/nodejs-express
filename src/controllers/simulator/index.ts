import {
  addSimulatorToProfileUseCase,
  viewAllSimulatorsUseCase,
  viewAllSimulatorForProfileUseCase,
} from "../../use-cases/simulator";
...
export const getAllSimulatorForProfileController =
  fetchAllSimulatorForProfileController({ viewAllSimulatorForProfileUseCase });
